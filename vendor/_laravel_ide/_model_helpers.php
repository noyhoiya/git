...
namespace App\Models {
	 ...
	 * @property string|null $purpose_text
	 * @property string|null $purpose_code
	 * @property string $amount_in_words
	 * @property integer $amount_cents
	 * @property mixed $requester_user_id
	 * @property mixed $requester_vault_id
	 * @property int $request_id
	 * @property-read mixed $amount
	 * @property-read \App\Models\Vault $requesterVault
	 ...
	 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\CashRequestDenom> $denominations
	 * @property-read int|null $denominations_count
	 * @property-read \App\Models\VaultMovement $vaultMovement
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequest>|CashRequest whereRequestId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequest>|CashRequest whereRequesterVaultId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequest>|CashRequest whereRequesterUserId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequest>|CashRequest whereAmountCents($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequest>|CashRequest whereAmountInWords($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequest>|CashRequest wherePurposeCode($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequest>|CashRequest wherePurposeText($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequest>|CashRequest whereStatus($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequest>|CashRequest whereCreatedAt($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequest>|CashRequest whereApprovedAt($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequest>|CashRequest whereApproverUserId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequest>|CashRequest whereNotes($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequest>|CashRequest newModelQuery()
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequest>|CashRequest newQuery()
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequest>|CashRequest query()
	 ...
	 */
	class CashRequest extends \Illuminate\Database\Eloquent\Model
	{
		//
	}

	/**
	 * App\Models\CashRequestDenom
	 *
	 ...
	 * @property-read \App\Models\CashRequest $cashRequest
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequestDenom>|CashRequestDenom whereId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequestDenom>|CashRequestDenom whereRequestId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequestDenom>|CashRequestDenom whereDenomination($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequestDenom>|CashRequestDenom whereQuantity($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequestDenom>|CashRequestDenom newModelQuery()
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequestDenom>|CashRequestDenom newQuery()
	 * @method static \Illuminate\Database\Eloquent\Builder<CashRequestDenom>|CashRequestDenom query()
	 * @method static mixed select($columns)
	 * @method static mixed selectSub($query, $as)
	 * @method static mixed selectRaw($expression, array $bindings)
	 * @method static mixed fromSub($query, $as)
	 ...
	 * @mixin \Illuminate\Database\Query\Builder
	 */
	class CashRequestDenom extends \Illuminate\Database\Eloquent\Model
	{
		//
	}
	 ...
	 * @method static \Illuminate\Database\Eloquent\Builder<Purpose>|Purpose newQuery()
	 * @method static \Illuminate\Database\Eloquent\Builder<Purpose>|Purpose query()
	 * @method static mixed select($columns)
	 * @method static mixed selectSub($query, $as)
	 * @method static mixed selectRaw($expression, array $bindings)
	 * @method static mixed fromSub($query, $as)
	 ...
	 * @property \Illuminate\Support\Carbon $created_at
	 * @property boolean $is_active
	 * @property integer $current_balance_cents
	 * @property mixed $vault_type
	 * @property string $vault_name
	 ...
	 * @method static \Illuminate\Database\Eloquent\Builder<Vault>|Vault whereCurrentBalanceCents($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Vault>|Vault whereIsActive($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Vault>|Vault whereCreatedAt($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Vault>|Vault whereUpdatedAt($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Vault>|Vault newModelQuery()
	 * @method static \Illuminate\Database\Eloquent\Builder<Vault>|Vault newQuery()
	 * @method static \Illuminate\Database\Eloquent\Builder<Vault>|Vault query()
	 * @method static mixed select($columns)
	 * @method static mixed selectSub($query, $as)
	 * @method static mixed selectRaw($expression, array $bindings)
	 * @method static mixed fromSub($query, $as)
	...
	/**
	 * App\Models\VaultMovement
	 *
	 * @property \Illuminate\Support\Carbon|null $posted_at
	 * @property \Illuminate\Support\Carbon $created_at
	 * @property mixed $received_by_user_id
	 * @property mixed $released_by_user_id
	 ...
	 * @property integer $amount_cents
	 * @property mixed $request_id
	 * @property mixed $to_vault_id
	 * @property mixed $from_vault_id
	 * @property mixed $type
	 * @property int $movement_id
	 * @property-read mixed $amount
	 * @property-read \App\Models\Vault $fromVault
	 * @property-read \App\Models\Vault $toVault
	 * @property-read \App\Models\CashRequest $cashRequest
	 * @property-read \App\Models\Purpose $purpose
	 * @property-read \App\Models\User $createdByUser
	 * @property-read \App\Models\User $releasedByUser
	 * @property-read \App\Models\User $receivedByUser
	 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\VaultMovementDenom> $denominations
	 * @property-read int|null $denominations_count
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovement>|VaultMovement whereMovementId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovement>|VaultMovement whereType($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovement>|VaultMovement whereFromVaultId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovement>|VaultMovement whereToVaultId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovement>|VaultMovement whereRequestId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovement>|VaultMovement whereAmountCents($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovement>|VaultMovement whereAmountInWords($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovement>|VaultMovement wherePurposeCode($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovement>|VaultMovement wherePurposeText($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovement>|VaultMovement whereStatus($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovement>|VaultMovement whereCreatedByUserId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovement>|VaultMovement whereReleasedByUserId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovement>|VaultMovement whereReceivedByUserId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovement>|VaultMovement whereCreatedAt($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovement>|VaultMovement wherePostedAt($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovement>|VaultMovement newModelQuery()
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovement>|VaultMovement newQuery()
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovement>|VaultMovement query()
	 * @method static mixed select($columns)
	 * @method static mixed selectSub($query, $as)
	 * @method static mixed selectRaw($expression, array $bindings)
	 * @method static mixed fromSub($query, $as)
	 ...
	 * @mixin \Illuminate\Database\Query\Builder
	 */
	class VaultMovement extends \Illuminate\Database\Eloquent\Model
	{
		//
	}

	/**
	 * App\Models\VaultMovementDenom
	 *
	 * @property integer $quantity
	 * @property integer $denomination
	 * @property mixed $movement_id
	 * @property int $id
	 * @property-read mixed $total_value
	 * @property-read \App\Models\VaultMovement $vaultMovement
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovementDenom>|VaultMovementDenom whereId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovementDenom>|VaultMovementDenom whereMovementId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovementDenom>|VaultMovementDenom whereDenomination($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovementDenom>|VaultMovementDenom whereQuantity($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovementDenom>|VaultMovementDenom newModelQuery()
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovementDenom>|VaultMovementDenom newQuery()
	 * @method static \Illuminate\Database\Eloquent\Builder<VaultMovementDenom>|VaultMovementDenom query()
	 * @method static mixed select($columns)
	 * @method static mixed selectSub($query, $as)
	 * @method static mixed selectRaw($expression, array $bindings)
	 * @method static mixed fromSub($query, $as)
	 ...
	 * @mixin \Illuminate\Database\Query\Builder
	 */
	class VaultMovementDenom extends \Illuminate\Database\Eloquent\Model
	{
		//
	}
