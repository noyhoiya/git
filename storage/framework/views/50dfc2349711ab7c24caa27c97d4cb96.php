    ...
    <div id="notifyDropdown" class="hidden absolute right-0 mt-2 w-96 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
        ...
        <ul class="max-h-64 overflow-y-auto">
            <?php $__empty_1 = true; $__currentLoopData = auth()->user()->unreadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                ?>
                <li class="p-2 hover:bg-gray-100 rounded flex justify-between items-center" data-id="<?php echo e($notification->id); ?>">
                    <a href="<?php echo e(route('cash-requests.index', ['id' => $data['request_id']])); ?>" 
                       class="flex-1 cursor-pointer no-underline text-gray-800">
                        <div>
                            <p class="text-sm font-medium"><?php echo e($data['requester_name']); ?></p>
                            <p class="text-xs text-gray-500">
                                ຄຳຂໍ <?php echo e(number_format($data['amount'], 2)); ?> ກີບ
                                <?php echo e($data['vault_name'] ?? 'a vault'); ?>

                                at <?php echo e(\Carbon\Carbon::parse($data['created_at'])->format('d M Y H:i')); ?>
