  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-50">
    <div class="max-w-md w-full space-y-8 p-8 bg-white rounded-xl shadow-lg">
        <div class="flex-shrink-0">
            <!-- Big Logo -->
            <img src="<?php echo e(asset('assets/image/logo_t.png')); ?>" alt="SSB Logo" class="h-40 w-auto mx-auto">
...
<?php /**PATH C:\xampp\htdocs\cash_center_v3\resources\views/auth/login.blade.php ENDPATH**/ ?>